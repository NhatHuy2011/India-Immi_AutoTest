...
public class LoginTestEN {
    ...
    void setUp() {
        ...
        driver.get("https://india-immi.org/en/login");
    }

    @Test
    void testLoginWithExcelData() throws InterruptedException {
        List<String[]> testData = ExcelUtils.readExcel(FILE_PATH, "Login_EN");
        ...
        for (String[] row : testData) {
            ...
            ExcelUtils.writeTestResults(FILE_PATH, "Login_EN", rowIndex, actualMessage, status);
